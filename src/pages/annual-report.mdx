...
<ul>
  <li>
    {" "}
    You can play with the numbers to create your own scenarios and test assumptions.
    Maybe you think ETH will rise more dramatically over the years, or want to see
    a scenario where all the money is given away in two years. Feel free to make
    a copy and experiment!
  </li>
  <li>
    {" "}
    Annually, the DAO can input actuals such as the average price of ETH from the
    prior year to refine the model and make course corrections as needed.
  </li>
</ul>
...
- RBG is assessing the impact of past grants by [interviewing grantees](https://medium.com/molochdao)
